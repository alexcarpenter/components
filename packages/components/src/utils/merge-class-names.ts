export type ClassName<State> = string | ((state: State) => string | undefined) | null | undefined;
...
export function mergeClassNames<State>(
  ...
  const hasStateCallback = classNames.some((className) => typeof className === "function");
